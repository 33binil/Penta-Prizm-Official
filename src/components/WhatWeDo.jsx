...
export default function WhatWeDo({ onSelectService }) {
  ...
  return (
    <section id="what-we-do" className="relative w-full bg-[#0a0a0a] text-white pt-16 pb-24 overflow-hidden">
      {/* Torn paper edge on top */}
      <div className="absolute top-0 left-0 right-0 h-8 bg-[#f4f4f2] torn-edge-bottom z-10" />

      {/* Ambient background glow */}
      <div className="absolute top-1/3 left-1/4 w-96 h-96 bg-[#ff3b19]/10 rounded-full blur-[120px] pointer-events-none" />

      <div className="w-full px-4 sm:px-6 relative z-20 pt-6">
        
        {/* Section Header */}
        <div className="mb-10 sm:mb-14">
          <h2 className="font-bebas text-5xl sm:text-7xl lg:text-8xl tracking-tight text-white uppercase">
            ЧТО МЫ ДЕЛАЕМ
          </h2>
          <div className="h-1 w-24 bg-[#ff3b19] mt-2" />
        </div>

        {/* 4-Quadrant Custom Grid Matching the Exact Poster Layout */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
          
          {/* 1. TOP-LEFT: КАСТОМ ДЛЯ ПРОЕКТОВ */}
          <div className="relative flex flex-col justify-between p-6 sm:p-8 rounded-xl border border-white/20 bg-neutral-950/80 backdrop-blur-sm min-h-[260px] group hover:border-[#ff3b19]/60 transition-all duration-300">
            <div>
              ...
              <h3 className="font-bebas text-3xl sm:text-4xl text-white tracking-wide uppercase mb-2">
                BUILD<br />YOUR IDENTITY
              </h3>
              <p className="font-montserrat text-sm text-neutral-400 font-medium">
            ...
            <div className="mt-6 flex items-center justify-between">
              <div className="font-marker text-[#ff3b19] text-2xl sm:text-3xl spray-text tracking-wide -rotate-3 select-none">
                Explore Branding →
                <svg className="w-24 h-4 text-[#ff3b19] mt-1" viewBox="0 0 100 20" fill="none">
              ...
              <button
                ...
                className="text-xs font-montserrat font-bold text-white/80 hover:text-[#ff3b19] uppercase tracking-wider underline cursor-pointer"
              >
                Подробнее
              </button>
            </div>
          ...
          {/* 2. TOP-RIGHT: АВТОРСКИЙ ДИЗАЙН (Box + Photo with Red Spray Loop) */}
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            
            {/* Box */}
            <div className="flex flex-col justify-between p-6 rounded-xl border border-white/20 bg-neutral-950/80 backdrop-blur-sm group hover:border-[#ff3b19]/60 transition-all">
              <div>
              ...
              <button
                ...
                className="text-xs font-montserrat font-bold text-white/80 hover:text-[#ff3b19] uppercase tracking-wider underline text-left mt-4 cursor-pointer"
              >
                Explore Digital →
              </button>
            </div>
            ...
            <div className="relative rounded-xl overflow-hidden border border-white/20 min-h-[220px] bg-neutral-900 group">
              <img
                src="https://images.unsplash.com/photo-1551488831-00ddcb6c6bd3?auto=format&fit=crop&w=600&q=80"
                alt="Авторский дизайн одежды"
              ...
              <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                <svg viewBox="0 0 100 100" className="w-28 h-28 text-[#ff3b19] spray-text">
                  <path
          ...
          {/* 3. BOTTOM-LEFT: PHOTO CARD WITH 'STR' + КАСТОМ ОДЕЖДЫ + 'DONT COPY — CREATE' */}
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            
            {/* Photo Card with 'STR' Spray Tag */}
            <div className="relative rounded-xl overflow-hidden border border-white/20 min-h-[220px] bg-neutral-900 group">
              <img
              ...
              {/* Large Orange-Red Spray Letters "STR" */}
            ...
            <div className="flex flex-col justify-between p-6 rounded-xl border border-white/20 bg-neutral-950/80 backdrop-blur-sm group hover:border-[#ff3b19]/60 transition-all">
              ...
              {/* Red Spray Tag: DONT COPY — CREATE */}
          ...
          {/* 4. BOTTOM-RIGHT: АПСАЙКЛИНГ (Box + Model Duo Photo) */}
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            {/* Photo Card: Streetwear Duo in Neon Ambient */}
            <div className="relative rounded-xl overflow-hidden border border-white/20 min-h-[220px] bg-neutral-900 group">
              <img
                src="https://images.unsplash.com/photo-1517841905240-472988babdf9?auto=format&fit=crop&w=600&q=80"
                alt="Upcycled Streetwear"
        ...
        <div className="mt-16 text-center select-none">
          <span className="font-marker text-2xl sm:text-3xl lg:text-4xl text-[#ff3b19] spray-text tracking-wide -rotate-1 inline-block">
